...
[![Version](https://img.shields.io/badge/version-0.26.0-blue.svg)](https://github.com/Ecronika/poise-thermostat/releases)
...
- **Norm-based comfort** — EN 16798-1 adaptive bands (Cat. I–III) on a real running-mean `T_rm`. The adaptive `T_rm` sets the comfort base; active heating/cooling then clamps into fixed per-category bands.
