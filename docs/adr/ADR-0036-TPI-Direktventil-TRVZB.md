...
**Status:** akzeptiert · **Datum:** 2026-06-22 · **Bezug:** ADR-0004 (TPI), ADR-0011 („Harness vor Hardware"), ADR-0015 (Aktorpfad-Capability), ADR-0032 (Closed-Loop) · **Verifizierung:** `tests/test_closed_loop.py` (TPI gegen RC-Plant), `tests/test_capability.py`, `tests/test_actuator.py`; Quellen z2m/VTherm/HA-Community
