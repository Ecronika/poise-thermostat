...
1. **Phase 2b wartet auf Daten**, nicht auf Code: eine Woche Zensus aus der Referenzanlage, dann Feed-Totband, Feed-Keepalive pro Gerätefamilie und `CALIBRATION_MIN_INTERVAL_S`.
