...
**Status:** akzeptiert · **Datum:** 2026-06-22 · **Bezug:** ADR-0015 (Aktorpfad PI_SETPOINT), ADR-0026/0033 (Schatten-Prinzip), ADR-0011 (Harness vor Hardware), ADR-0036 (TPI-Shadow, Schwester) · **Verifizierung:** `tests/test_closed_loop.py` (Droop-Reduktion gegen RC-Plant), `tests/test_pi_shadow.py`
