...
**Status:** In Arbeit (30 %) · **Datum:** 2026-06-28 · **Bezug:** Poise v0.92.0; ADR-0005 (Pure-Core/Glue), ADR-0012 (Safety/Window/Heating-Failure), ADR-0013/0038 (Hub), ADR-0023 (Dual-Setpoint), ADR-0035 (Constraint-Solver, Präzedenz), ADR-0042 (Override).
