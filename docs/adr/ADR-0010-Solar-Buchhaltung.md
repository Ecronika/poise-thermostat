...
**Status:** Implementiert · **Wirkung:** Live-A · **Datum:** 2026-06-18 · **Bezug:** E19, K3 · **Verifizierung:** Code-Review RoomMind `solar.py`/`mpc_controller.py`/`thermal_model.py`, BT `mpc.py` (Thema F)
