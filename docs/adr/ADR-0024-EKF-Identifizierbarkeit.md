...
**Status:** akzeptiert · **Datum:** 2026-06-19 · **Bezug:** Livetest v0.6.0, ADR-0002/0009 · **Verifizierung:** RoomMind `thermal_model.py`/`mpc_controller.py`, Better Thermostat `mpc.py`
