...
**Offen:** §2 Modus-Saison-Hinweis (optional, nicht Teil dieses Schnitts); §3 Golden-Replay-Tuning an Feld-Traces → danach Default-Flip; HA-Runtime-Integrationstest für den Fix-Flow (CI); ADR-0067-F2-Kollisionsregel konsumiert künftig die jetzt publizierten `suggestion_*`-Keys.
