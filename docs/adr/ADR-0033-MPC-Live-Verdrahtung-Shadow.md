...
**Status:** akzeptiert · **Datum:** 2026-06-21 · **Bezug:** ADR-0001 (MPC), ADR-0009 (Gate), ADR-0026 (Schatten-Prinzip), ADR-0032 (Closed-Loop-Validierung) · **Verifizierung:** `control/mpc_shadow.py` + `tests/test_mpc_shadow.py`; volles Gate grün
