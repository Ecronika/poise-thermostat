...
**Status:** Implementiert · **Wirkung:** Live-D · **Datum:** 2026-06-20 · **Bezug:** Charta G17 („schlechte Sensorik wird erkannt, nicht geglaubt"), ADR-0002/0024 (EKF), ADR-0012 (Repair-Issues), externe Review #2 · **Verifizierung:** EKF-`tau_hours`/`identified`
