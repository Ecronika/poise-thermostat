...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Fe=/'/g,Ve=/"/g,je=/^(?:script|style|textarea|title)$/i,Ce=n=>(e,...t)=>({_$litType$:n,strings:e,values:t}),m=Ce(1),qe=Ce(2),un=Ce(3),M=Symbol.for("lit-noChange"),p=Symbol.for("lit-nothing"),ze=new WeakMap,E=P.createTreeWalker(P,129);function We(n,e){if(!we(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ie!==void 0?Ie.createHTML(e):e}var St=(n,e)=>{let t=n.length-1,o=[],r,s=e===2?"<svg>":e===3?"<math>":"",i=V;for(let l=0;l<t;l++){let a=n[l],d,f,h=-1,g=0;for(;g<a.length&&(i.lastIndex=g,f=i.exec(a),f!==null);)g=i.lastIndex,i===V?f[1]==="!--"?i=Ne:f[1]!==void 0?i=Ue:f[2]!==void 0?(je.test(f[2])&&(r=RegExp("</"+f[2],"g")),i=k):f[3]!==void 0&&(i=k):i===k?f[0]===">"?(i=r??V,h=-1):f[1]===void 0?h=-2:(h=i.lastIndex-f[2].length,d=f[1],i=f[3]===void 0?k:f[3]==='"'?Ve:Fe):i===Ve||i===Fe?i=k:i===Ne||i===Ue?i=V:(i=k,r=void 0);let x=i===k&&n[l+1].startsWith("/>")?" ":"";s+=i===V?a+Ct:h>=0?(o.push(d),a.slice(0,h)+Be+a.slice(h)+C+x):a+C+(h===-2?l:x)}return[We(n,s+(n[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),o]},K=class n{constructor({strings:e,_$litType$:t},o){let r;this.parts=[];let s=0,i=0,l=e.length-1,a=this.parts,[d,f]=St(e,t);if(this.el=n.createElement(d,o),E.currentNode=this.el.content,t===2||t===3){let h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(r=E.nextNode())!==null&&a.length<l;){if(r.nodeType===1){if(r.hasAttributes())for(let h of r.getAttributeNames())if(h.endsWith(Be)){let g=f[i++],x=r.getAttribute(h).split(C),$=/([.?@])?(.*)/.exec(g);a.push({type:1,index:s,name:$[2],strings:x,ctor:$[1]==="."?be:$[1]==="?"?ye:$[1]==="@"?ve:H}),r.removeAttribute(h)}else h.startsWith(C)&&(a.push({type:6,index:s}),r.removeAttribute(h));if(je.test(r.tagName)){let h=r.textContent.split(C),g=h.length-1;if(g>0){r.textContent=ee?ee.emptyScript:"";for(let x=0;x<g;x++)r.append(h[x],z()),E.nextNode(),a.push({type:2,index:++s});r.append(h[g],z())}}}else if(r.nodeType===8)if(r.data===Ke)a.push({type:2,index:s});else{let h=-1;for(;(h=r.data.indexOf(C,h+1))!==-1;)a.push({type:7,index:s}),h+=C.length-1}s++}}static createElement(e,t){let o=P.createElement("template");return o.innerHTML=e,o}};function R(n,e,t=n,o){if(e===M)return e;let r=o!==void 0?t._$Co?.[o]:t._$Cl,s=B(e)?void 0:e._$litDirective$;return r?.constructor!==s&&(r?._$AO?.(!1),s===void 0?r=void 0:(r=new s(n),r._$AT(n,t,o)),o!==void 0?(t._$Co??=[])[o]=r:t._$Cl=r),r!==void 0&&(e=R(n,r._$AS(n,e.values),r,o)),e}var ge=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:o}=this._$AD,r=(e?.creationScope??P).importNode(t,!0);E.currentNode=r;let s=E.nextNode(),i=0,l=0,a=o[0];for(;a!==void 0;){if(i===a.index){let d;a.type===2?d=new j(s,s.nextSibling,this,e):a.type===1?d=new a.ctor(s,a.name,a.strings,this,e):a.type===6&&(d=new xe(s,this,e)),this._$AV.push(d),a=o[++l]}i!==a?.index&&(s=E.nextNode(),i++)}return E.currentNode=P,r}p(e){let t=0;for(let o of this._$AV)o!==void 0&&(o.strings!==void 0?(o._$AI(e,o,t),t+=o.strings.length-2):o._$AI(e[t])),t++}},j=class n{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,o,r){this.type=2,this._$AH=p,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=o,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=R(this,e,t),B(e)?e===p||e==null||e===""?(this._$AH!==p&&this._$AR(),this._$AH=p):e!==this._$AH&&e!==M&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):At(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==p&&B(this._$AH)?this._$AA.nextSibling.data=e:this.T(P.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:o}=e,r=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=K.createElement(We(o.h,o.h[0]),this.options)),o);if(this._$AH?._$AD===r)this._$AH.p(t);else{let s=new ge(r,this),i=s.u(this.options);s.p(t),this.T(i),this._$AH=s}}_$AC(e){let t=ze.get(e.strings);return t===void 0&&ze.set(e.strings,t=new K(e)),t}k(e){we(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,o,r=0;for(let s of e)r===t.length?t.push(o=new n(this.O(z()),this.O(z()),this,this.options)):o=t[r],o._$AI(s),r++;r<t.length&&(this._$AR(o&&o._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let o=De(e).nextSibling;De(e).remove(),e=o}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},H=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,o,r,s){this.type=1,this._$AH=p,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=s,o.length>2||o[0]!==""||o[1]!==""?(this._$AH=Array(o.length-1).fill(new String),this.strings=o):this._$AH=p}_$AI(e,t=this,o,r){let s=this.strings,i=!1;if(s===void 0)e=R(this,e,t,0),i=!B(e)||e!==this._$AH&&e!==M,i&&(this._$AH=e);else{let l=e,a,d;for(e=s[0],a=0;a<s.length-1;a++)d=R(this,l[o+a],t,a),d===M&&(d=this._$AH[a]),i||=!B(d)||d!==this._$AH[a],d===p?e=p:e!==p&&(e+=(d??"")+s[a+1]),this._$AH[a]=d}i&&!r&&this.j(e)}j(e){e===p?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},be=class extends H{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===p?void 0:e}},ye=class extends H{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==p)}},ve=class extends H{constructor(e,t,o,r,s){super(e,t,o,r,s),this.type=5}_$AI(e,t=this){if((e=R(this,e,t,0)??p)===M)return;let o=this._$AH,r=e===p&&o!==p||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,s=e!==p&&(o===p||r);r&&this.element.removeEventListener(this.name,this,o),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},xe=class{constructor(e,t,o){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=o}get _$AU(){return this._$AM._$AU}_$AI(e){R(this,e)}};var kt=$e.litHtmlPolyfillSupport;kt?.(K,j),($e.litHtmlVersions??=[]).push("3.3.3");var Ge=(n,e,t)=>{let o=t?.renderBefore??e,r=o._$litPart$;if(r===void 0){let s=t?.renderBefore??null;o._$litPart$=r=new j(e.insertBefore(z(),s),s,void 0,t??{})}return r._$AI(n),r};var Ae=globalThis,v=class extends w{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Ge(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return M}};v._$litElement$=!0,v.finalized=!0,Ae.litElementHydrateSupport?.({LitElement:v});var Et=Ae.litElementPolyfillSupport;Et?.({LitElement:v});(Ae.litElementVersions??=[]).push("4.2.2");function Pt(n,e,t){return Math.min(Math.max(n,e),t)}function te(n,e,t){return t<=e?.5:Pt((n-e)/(t-e),0,1)}function Mt(n,e,t){if(n==null)return"unknown";if(n<e)return"below";if(n>t)return"above";let o=t-e;if(o<=0)return"in_band";let r=(n-e)/o;return r<.25?"cool_edge":r>.75?"warm_edge":"in_band"}function Xe(n){let{operative:e,setpoint:t,low:o,high:r}=n;if(o==null||r==null||r<=o)return null;let s=o-1.5,i=r+1.5;return{low:o,high:r,span:r-o,operative:e,setpoint:t,category:n.category??"",verdict:Mt(e,o,r),axisLow:s,axisHigh:i,lowFrac:te(o,s,i),highFrac:te(r,s,i),operativeFrac:e==null?null:te(e,s,i),setpointFrac:t==null?null:te(t,s,i)}}var Ye={ok:"var(--success-color, #43a047)",warn:"var(--warning-color, #fb8c00)",alert:"var(--error-color, #e53935)",unknown:"var(--disabled-text-color, #9e9e9e)"};function q(n){return Ye[n]??Ye.unknown}var Lt=[1e3,2e3],Rt=[30,40,60,65],Ht=[26,30],Tt=420,Ot=[800,1350];function _(n){return typeof n=="number"&&Number.isFinite(n)}function ne(n,e){return n&&n.length>=2&&_(n[0])&&_(n[1])&&n[0]<n[1]?[n[0],n[1]]:[e[0],e[1]]}function Dt(n,e){if(n&&n.length>=4&&n.slice(0,4).every(_)){let[t,o,r,s]=n;if(t<=o&&o<=r&&r<=s)return[t,o,r,s]}return[e[0],e[1],e[2],e[3]]}function It(n){if(n?.scheme==="en16798"){let e=_(n.outdoor)?n.outdoor:Tt,t=ne(n.enRise,Ot);return[e+t[0],e+t[1]]}return ne(n?.thresholds,Lt)}function Nt(n,e){if(!_(n))return"unknown";let[t,o]=It(e);return n>=o?"alert":n>=t?"warn":"ok"}function Ut(n,e){if(!_(n))return"unknown";let[t,o,r,s]=Dt(e,Rt);return n<t||n>=s?"alert":n<o||n>r?"warn":"ok"}function Ft(n){switch(n){case"in_band":return"ok";case"cool_edge":case"warm_edge":return"warn";case"below":case"above":return"alert";default:return"unknown"}}function Vt(n,e){if(!_(n))return"unknown";let[t,o]=ne(e,Ht);return n>o?"alert":n>t?"warn":"ok"}var zt=[10,15];function Bt(n){return 100-95*Math.exp(-(.03353*n**4+.2179*n**2))}function Kt(n,e,t){let[o,r]=ne(t,zt),s=_(e)?e:_(n)?Bt(n):null;return s==null?"unknown":s>=r?"alert":s>=o?"warn":"ok"}var jt=[.5,1],qt=[3,6],Wt=[85,60];function Je(n){return n<=1?n*100:n}var Ze={unknown:-1,ok:0,warn:1,alert:2};function Gt(n){let e=[];if(_(n.deviationK)){let[t,o]=jt;e.push(n.deviationK>=o?"alert":n.deviationK>=t?"warn":"ok")}if(_(n.cyclesPerH)){let[t,o]=qt;e.push(n.cyclesPerH>=o?"alert":n.cyclesPerH>=t?"warn":"ok")}if(_(n.timeInBand)){let t=Je(n.timeInBand),[o,r]=Wt;e.push(t<r?"alert":t<o?"warn":"ok")}return e.length?e.reduce((t,o)=>Ze[o]>Ze[t]?o:t,"ok"):"unknown"}function Qe(n,e){let t=[],o=e?.temperature_scale==="asr_office"?Vt(n.temperature,e.asr_thresholds):Ft(n.comfortVerdict??null);if(t.push({key:"temperature",value:n.temperature,unit:"\xB0C",level:o,color:q(o)}),_(n.humidity)){let s=Ut(n.humidity,e?.humidity_thresholds);t.push({key:"humidity",value:n.humidity,unit:"%",level:s,color:q(s)})}if(_(n.co2)){let s=Nt(n.co2,{scheme:e?.co2_scheme,thresholds:e?.co2_thresholds,outdoor:e?.outdoor_co2});t.push({key:"co2",value:n.co2,unit:"ppm",level:s,color:q(s)})}if(_(n.pmv)||_(n.ppd)){let s=Kt(n.pmv??null,n.ppd??null);t.push({key:"pmv",value:_(n.ppd)?n.ppd:null,unit:"%",level:s,color:q(s)})}let r=n.ca;if(r&&(_(r.deviationK)||_(r.timeInBand)||_(r.cyclesPerH))){let s=Gt(r);t.push({key:"ca",value:_(r.timeInBand)?Je(r.timeInBand):null,unit:"%",level:s,color:q(s)})}return t}var Se=["hvac","window","temperature","humidity","co2","ca"],Xt=[12,24,48];function et(n,e,t){return typeof n=="string"&&e.includes(n)?n:t}function T(n,e){return typeof n=="boolean"?n:e}function Yt(n){return n===!1?new Set:n==null||n===!0?new Set(Se):Array.isArray(n)?new Set(n.filter(e=>Se.includes(e))):new Set(Se)}function Zt(n){if(n===!1)return{show:!1,hours:24};if(n===!0||n==null)return{show:!0,hours:24};let e=typeof n.hours=="number"?n.hours:Number(n.hours),t=Xt.includes(e)?e:24;return{show:T(n.show,!0),hours:t}}function tt(n){let e=n.sections??{},t=n.density?et(n.density,["comfortable","compact"],"comfortable"):n.compact?"compact":"comfortable";return{entity:n.entity,density:t,controls:et(n.controls,["dial","buttons","none"],"dial"),history:Zt(n.history),chips:Yt(e.chips),shadowPill:T(e.shadow_pill,T(n.show_shadow,!0)),learning:T(e.learning,!0),pmv:T(e.pmv,!0),presets:T(e.presets,!0),temperature_scale:n.temperature_scale,humidity_thresholds:n.humidity_thresholds,co2_scheme:n.co2_scheme,co2_thresholds:n.co2_thresholds}}var nt={in_band:"In comfort band",cool_edge:"Cool edge of band",warm_edge:"Warm edge of band",below:"Below comfort band",above:"Above comfort band",unknown:"No reading",preheating:"Pre-heating",coasting:"Coasting",window:"Window open",window_auto:"Window (auto)",bypass:"Window detection off",eco:"Eco",comfort:"Comfort",boost:"Boost",away:"Away",failure:"Heating failure",learning:"Learning",shadow:"Shadow active",setpoint:"Setpoint",no_entity:"Select a Poise thermostat entity.",min_left:"min",no_system:"Select the Poise System sensor.",sys_title:"Poise System",demand_on:"Boiler demand",demand_off:"No demand",frost:"Frost override",zones:"zones",heating_n:"heating",flow:"Flow",shed:"shed",shadow_would:"would",update_msg:"New Poise card version available \u2014 reload to update.",reload:"Reload",details:"Show details",temperature:"Temperature",humidity:"Humidity",co2:"CO\u2082",pmv:"Comfort",ca:"Regulation",override_clamped:"Setpoint clamped",manual:"Manual",resume_schedule:"Resume schedule",valid_until:"valid until",instead_of:"instead of",norm_limit:"norm limit",permanent:"permanent",compressor_guard:"Compressor guard",mould:"Mould limit",presets:"Presets",air_quality:"Room condition",air_ok:"OK",air_warn:"Elevated",air_alert:"Critical"},Jt={in_band:"Im Komfortband",cool_edge:"Untere Bandkante",warm_edge:"Obere Bandkante",below:"Unter dem Komfortband",above:"\xDCber dem Komfortband",unknown:"Kein Messwert",preheating:"Vorheizen",coasting:"Auslaufen",window:"Fenster offen",window_auto:"Fenster (auto)",bypass:"Fenster-Erkennung aus",eco:"Eco",comfort:"Komfort",boost:"Boost",away:"Abwesend",failure:"Heizausfall",learning:"Lernt",shadow:"Shadow aktiv",setpoint:"Sollwert",no_entity:"Bitte eine Poise-Thermostat-Entit\xE4t w\xE4hlen.",min_left:"Min",no_system:"Bitte den Poise-System-Sensor w\xE4hlen.",sys_title:"Poise System",demand_on:"Kesselbedarf",demand_off:"Kein Bedarf",frost:"Frost-Override",zones:"Zonen",heating_n:"heizen",flow:"Vorlauf",shed:"abgeworfen",shadow_would:"w\xFCrde",update_msg:"Neue Poise-Karten-Version verf\xFCgbar \u2014 zum Aktualisieren neu laden.",reload:"Neu laden",details:"Details anzeigen",temperature:"Temperatur",humidity:"Feuchte",co2:"CO\u2082",pmv:"Behaglichkeit",ca:"Regelg\xFCte",override_clamped:"Sollwert geklemmt",manual:"Manuell",resume_schedule:"Zeitplan fortsetzen",valid_until:"gilt bis",instead_of:"statt",norm_limit:"Normgrenze",permanent:"dauerhaft",compressor_guard:"Verdichterschutz",mould:"Schimmelgrenze",presets:"Voreinstellungen",air_quality:"Raumzustand",air_ok:"OK",air_warn:"Erh\xF6ht",air_alert:"Kritisch"};function c(n,e){return((n??"en").toLowerCase().startsWith("de")?Jt:nt)[e]??nt[e]??e}var Qt=[{value:"hvac",label:"HVAC status"},{value:"window",label:"Window"},{value:"temperature",label:"Temperature"},{value:"humidity",label:"Humidity"},{value:"co2",label:"CO\u2082"},{value:"ca",label:"Regulation (CA)"}],en=[{name:"entity",required:!0,selector:{entity:{integration:"poise",domain:"climate"}}},{name:"density",selector:{select:{mode:"dropdown",options:[{value:"comfortable",label:"Comfortable"},{value:"compact",label:"Compact"}]}}},{name:"controls",selector:{select:{mode:"dropdown",options:[{value:"dial",label:"Dial (drag)"},{value:"buttons",label:"Buttons (+/\u2212)"},{value:"none",label:"Display only"}]}}},{type:"expandable",name:"history",title:"History",schema:[{name:"show",selector:{boolean:{}}},{name:"hours",selector:{select:{mode:"dropdown",options:[{value:12,label:"12 h"},{value:24,label:"24 h"},{value:48,label:"48 h"}]}}}]},{type:"expandable",name:"sections",title:"Sections",schema:[{name:"chips",selector:{select:{multiple:!0,options:Qt}}},{name:"pmv",selector:{boolean:{}}},{name:"presets",selector:{boolean:{}}},{name:"shadow_pill",selector:{boolean:{}}},{name:"learning",selector:{boolean:{}}}]},{type:"expandable",name:"",title:"Advanced",flatten:!0,schema:[{name:"temperature_scale",selector:{select:{mode:"dropdown",options:[{value:"comfort",label:"Comfort band"},{value:"asr_office",label:"ASR office (\u226426 \xB0C)"}]}}},{name:"co2_scheme",selector:{select:{mode:"dropdown",options:[{value:"uba",label:"UBA (absolute)"},{value:"en16798",label:"EN 16798 (outdoor offset)"}]}}}]}],tn={entity:"Entity",density:"Density",controls:"Controls",history:"History",sections:"Sections",show:"Show graph",hours:"Time span",chips:"Condition chips",pmv:"Comfort (PMV) lamp",presets:"Preset buttons",shadow_pill:"Shadow pill",learning:"Learning bar",temperature_scale:"Temperature scale",co2_scheme:"CO\u2082 scale"},oe=class extends v{setConfig(e){this._config=e}shouldUpdate(e){return e.has("hass")||e.has("_config")}_changed(e){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e.detail.value}}))}render(){return!this.hass||!this._config?m``:m`<ha-form
    ...
    ></ha-form>`}};oe.properties={hass:{},_config:{state:!0}};customElements.get("poise-card-editor")||customElements.define("poise-card-editor",oe);var re="0.162.1",ot=!1;function nn(){let n=()=>location.reload();"caches"in window?caches.keys().then(e=>Promise.all(e.map(t=>caches.delete(t)))).then(n,n):n()}async function se(n,e){if(!(ot||!e?.connection)){ot=!0;try{let t=await e.connection.sendMessagePromise({type:"poise/card_version"});if(t?.version&&t.version!==re){let o=e.locale?.language;n.dispatchEvent(new CustomEvent("hass-notification",{detail:{message:`${c(o,"update_msg")} (${re} \u2192 ${t.version})`,duration:-1,dismissable:!0,action:{text:c(o,"reload"),action:nn}},bubbles:!0,composed:!0}))}}catch{}}}function W(n){let e=typeof n=="string"?parseFloat(n):n;return typeof e=="number"&&!Number.isNaN(e)?e:null}var G=class extends v{static getConfigElement(){return document.createElement("poise-system-card-editor")}static getStubConfig(e){return{type:"custom:poise-system-card",entity:Object.keys(e.states).find(o=>o.startsWith("binary_sensor.")&&e.states[o].attributes.zone_count!==void 0)??""}}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config=e}getCardSize(){return 2}getGridOptions(){return{columns:12,rows:"auto",min_columns:4,min_rows:4}}updated(){this.hass&&se(this,this.hass)}shouldUpdate(e){if(e.has("_config"))return!0;let t=e.get("hass");return!t||!this._config?.entity?!0:t.states[this._config.entity]!==this.hass.states[this._config.entity]}_moreInfo(){this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:this._config.entity},bubbles:!0,composed:!0}))}_onActivateKey(e){(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this._moreInfo())}render(){let e=this.hass?.locale?.language,t=this._config?.entity,o=t?this.hass.states[t]:void 0;if(!o)return m`<ha-card
      ...
      >
        <div class="state ${s?"on":""}">
          ...
          ${r.frost_override?m`<em class="frost">${c(e,"frost")}</em>`:p}
        </div>
        <div class="stats">
          <div>
  ...
  `;var ie=class extends v{setConfig(e){this._config=e}shouldUpdate(e){return e.has("hass")||e.has("_config")}_changed(e){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e.detail.value}}))}render(){return!this.hass||!this._config?m``:m`<ha-form
    ...
    >
    ...
    </svg>`:p}render(){let t=this.hass?.locale?.language,o=this._config?.entity,r=o?this.hass.states[o]:void 0;if(!r)return m`<ha-card
        ><div class="empty">${c(t,"no_entity")}</div></ha-card
      >`;let s=r.attributes,i=u(s.operative_temperature)??u(s.current_temperature),l=u(s.heat_sp)??u(s.temperature),a=Xe({operative:i,setpoint:l,low:u(s.comfort_low),high:u(s.comfort_high),category:s.category??null}),d=this._r;return m`<ha-card .header=${s.friendly_name??"Poise"}>
      <div class="wrap ${d.density==="compact"?"compact":""}">
        ...
        ${this._holdPill(s,t)}
        ${d.controls==="buttons"?this._control(this._pending??l,t):p}
        ${this._presets(s,t)}
        ${d.history.show?this._chart(u(s.comfort_low),u(s.comfort_high)):p}
        ${this._monitor(s,a,t)} ${this._chips(s,t)}
        ${this._learn(s,t)}
      </div>
    </ha-card>`}_dial(t,o){let r=u(t.operative_temperature)??u(t.current_temperature),s=u(t.heat_sp)??u(t.temperature),i={min:u(t.min_temp)??y.min,max:u(t.max_temp)??y.max,start:y.start,sweep:y.sweep};this._dialCfg=i.max>i.min?i:y;let l=this._pending??s??r??this._dialCfg.min,a=u(t.comfort_low),d=u(t.comfort_high),f=100,h=100,g=80,x=ke(f,h,g,y.start,y.start+y.sweep),$=a!=null&&d!=null?ke(f,h,g,O(Math.min(a,d),this._dialCfg),O(Math.max(a,d),this._dialCfg)):"",D=String(t.hvac_action??""),b=D==="heating"?"heat":D==="cooling"?"cool":"",S=A(f,h,g,O(l,this._dialCfg)),ae=r!=null?A(f,h,g,O(r,this._dialCfg)):null,L=u(t.mould_floor),I=L!=null&&L>this._dialCfg.min&&L<this._dialCfg.max,le=I?O(L,this._dialCfg):0,ce=I?A(f,h,g-9,le):null,ue=I?A(f,h,g+9,le):null,de=I?A(f,h,g+17,le):null,pe=this._r.controls==="dial",Y=this._dragging?ct(t.override_expires_at,o):null,ft=`${l.toFixed(1)} \xB0C${Y?` \xB7 ${c(o,"valid_until")} ${Y}`:""}`;return m`<div class="dialwrap">
      <svg
        class="dial ${pe?"":"ro"}"
        viewBox="0 0 200 200"
        role=${pe?"slider":"img"}
      ...
      >
        ...
        ${I&&ce&&ue&&de?qe`<line class="mould" x1=${ce.x.toFixed(1)} y1=${ce.y.toFixed(1)} x2=${ue.x.toFixed(1)} y2=${ue.y.toFixed(1)}><title>${c(o,"mould")} ${L.toFixed(1)}°</title></line><text class="mlbl" x=${de.x.toFixed(1)} y=${de.y.toFixed(1)}>${L.toFixed(0)}°</text>`:p}
        <circle
          class="opdot"
          cx=${(ae?.x??0).toFixed(1)}
          cy=${(ae?.y??0).toFixed(1)}
      ...
      ${r.map(l=>{let a=String(l),d=a.toLowerCase();return m`<button
        ...
        >
          ...
          <span>${c(o,d)||a}</span>
          ${d==="boost"&&i!=null?m`<em>${i} ${c(o,"min_left")}</em>`:p}
        </button>`})}
    </div>`}_holdPill(t,o){if(!t.override_active)return p;let r=Pe(t),s=ut(o,r,t.override_policy,t.override_expires_at);return m`<div class="hold">
      <div class="chip hold-chip">
        <ha-icon icon="mdi:hand-back-right"></ha-icon><span>${s.label}</span>
        ${s.minutes!=null?m`<em>· ${s.minutes} ${c(o,"min_left")}</em>`:p}
      </div>
      <button
        class="resume"
      ...
      >
    ...
    </div>`}_chips(t,o){let r=this._r,s=[];if(r.chips.has("hvac")){t.preheating&&s.push(this._chip("mdi:fire-circle",c(o,"preheating"),t.minutes_to_comfort,o)),t.coasting&&s.push(this._chip("mdi:coffee",c(o,"coasting"),t.minutes_to_setback,o));let i=pt(o,t.preset,r.presets);i&&s.push(this._chip(mt(i.key),i.label)),t.heating_failure&&s.push(this._chip("mdi:alert",c(o,"failure"))),t.override_clamped&&s.push(this._chip("mdi:arrow-collapse-vertical",dt(o,Pe(t),u(t.override_requested)))),t.mode_nudge_blocked&&s.push(this._chip("mdi:timer-sand",`${c(o,"compressor_guard")}: ${t.mode_nudge_blocked}`));let l=t.binding_lower_cause;l&&l!=="en16798"&&s.push(this._chip("mdi:shield-alert",String(l)))}return r.chips.has("window")&&(t.window_open&&s.push(this._chip("mdi:window-open",c(o,t.window_auto_detected?"window_auto":"window"))),t.window_bypass&&s.push(this._chip("mdi:window-closed-variant",c(o,"bypass")))),s.length?m`<div
          class="chips"
          role="button"
          tabindex="0"
          aria-label=${c(o,"details")}
        ...
        >
          ${s}
        </div>`:p}_chip(t,o,r,s){let i=u(r);return m`<div class="chip">
      <ha-icon icon=${t}></ha-icon><span>${o}</span>
      ${i!=null?m`<em>${Math.round(i)} ${c(s,"min_left")}</em>`:p}
    </div>`}_monitor(t,o,r){let s=Qe({temperature:u(t.operative_temperature)??u(t.current_temperature),comfortVerdict:o?.verdict??null,humidity:u(t.humidity)??u(t.current_humidity),co2:u(t.co2)??u(t.carbon_dioxide),pmv:u(t.pmv),ppd:u(t.ppd),ca:{deviationK:u(t.ca_deviation_k),timeInBand:u(t.ca_time_in_band),cyclesPerH:u(t.ca_cycles_per_h)}},{temperature_scale:this._config.temperature_scale,humidity_thresholds:this._config.humidity_thresholds,co2_scheme:this._config.co2_scheme,co2_thresholds:this._config.co2_thresholds,outdoor_co2:u(t.outdoor_co2)}),i=this._r,l=s.filter(a=>a.key==="pmv"?i.pmv:i.chips.has(a.key));return l.length?m`<div
      class="monitor"
      role="group"
      aria-label=${c(r,"air_quality")}
    >
      ${l.map(a=>this._lamp(a,r))}
    </div>`:p}_lamp(t,o){let r=c(o,t.key),s=c(o,t.level==="unknown"?"unknown":"air_"+t.level),i="\u2014";t.value!=null&&(i=t.key==="temperature"?t.value.toFixed(1):String(Math.round(t.value)));let l=`${r}: ${i} ${t.unit} \u2014 ${s}`;return m`<div class="lamp" title=${l} aria-label=${l}>
      <span class="dot" style="background:${t.color}"></span>
      <span class="lk">${r}</span>
      <span class="lv">${i}<small>${t.unit}</small></span>
    </div>`}_learn(t,o){let r=u(t.confidence),s=this._r.learning&&r!=null,i=this._r.shadowPill&&(t.mpc_active||t.tpi_active||t.pi_active);if(!s&&!i)return p;let l=u(t.pi_setpoint),a=u(t.mpc_setpoint),d=t.tpi_active?`TPI ${Math.round(u(t.tpi_valve_percent)??0)}%`:t.pi_active&&l!=null?`PI ${l.toFixed(1)}\xB0`:t.mpc_active&&a!=null?`MPC ${a.toFixed(1)}\xB0`:"";return m`<div class="learn">
      ${s?m`<div class="bar">
            <i style="width:${((r??0)*100).toFixed(0)}%"></i>
          </div>
          <span>${c(o,"learning")} ${((r??0)*100).toFixed(0)}%</span>`:p}
      ${i?m`<div class="pill">
            ${c(o,"shadow")}${d?m` · ${d}`:p}
          </div>`:p}
