...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ct=/'/g,St=/"/g,Mt=/^(?:script|style|textarea|title)$/i,pt=i=>(t,...e)=>({_$litType$:i,strings:t,values:e}),u=pt(1),de=pt(2),he=pt(3),k=Symbol.for("lit-noChange"),d=Symbol.for("lit-nothing"),Et=new WeakMap,S=E.createTreeWalker(E,129);function Ut(i,t){if(!ht(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return xt!==void 0?xt.createHTML(t):t}var Xt=(i,t)=>{let e=i.length-1,s=[],n,o=t===2?"<svg>":t===3?"<math>":"",r=N;for(let c=0;c<e;c++){let a=i[c],l,m,h=-1,_=0;for(;_<a.length&&(r.lastIndex=_,m=r.exec(a),m!==null);)_=r.lastIndex,r===N?m[1]==="!--"?r=wt:m[1]!==void 0?r=At:m[2]!==void 0?(Mt.test(m[2])&&(n=RegExp("</"+m[2],"g")),r=C):m[3]!==void 0&&(r=C):r===C?m[0]===">"?(r=n??N,h=-1):m[1]===void 0?h=-2:(h=r.lastIndex-m[2].length,l=m[1],r=m[3]===void 0?C:m[3]==='"'?St:Ct):r===St||r===Ct?r=C:r===wt||r===At?r=N:(r=C,n=void 0);let $=r===C&&i[c+1].startsWith("/>")?" ":"";o+=r===N?a+qt:h>=0?(s.push(l),a.slice(0,h)+kt+a.slice(h)+w+$):a+w+(h===-2?c:$)}return[Ut(i,o+(i[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),s]},I=class i{constructor({strings:t,_$litType$:e},s){let n;this.parts=[];let o=0,r=0,c=t.length-1,a=this.parts,[l,m]=Xt(t,e);if(this.el=i.createElement(l,s),S.currentNode=this.el.content,e===2||e===3){let h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(n=S.nextNode())!==null&&a.length<c;){if(n.nodeType===1){if(n.hasAttributes())for(let h of n.getAttributeNames())if(h.endsWith(kt)){let _=m[r++],$=n.getAttribute(h).split(w),b=/([.?@])?(.*)/.exec(_);a.push({type:1,index:o,name:b[2],strings:$,ctor:b[1]==="."?rt:b[1]==="?"?at:b[1]==="@"?ct:M}),n.removeAttribute(h)}else h.startsWith(w)&&(a.push({type:6,index:o}),n.removeAttribute(h));if(Mt.test(n.tagName)){let h=n.textContent.split(w),_=h.length-1;if(_>0){n.textContent=G?G.emptyScript:"";for(let $=0;$<_;$++)n.append(h[$],O()),S.nextNode(),a.push({type:2,index:++o});n.append(h[_],O())}}}else if(n.nodeType===8)if(n.data===Pt)a.push({type:2,index:o});else{let h=-1;for(;(h=n.data.indexOf(w,h+1))!==-1;)a.push({type:7,index:o}),h+=w.length-1}o++}}static createElement(t,e){let s=E.createElement("template");return s.innerHTML=t,s}};function P(i,t,e=i,s){if(t===k)return t;let n=s!==void 0?e._$Co?.[s]:e._$Cl,o=D(t)?void 0:t._$litDirective$;return n?.constructor!==o&&(n?._$AO?.(!1),o===void 0?n=void 0:(n=new o(i),n._$AT(i,e,s)),s!==void 0?(e._$Co??=[])[s]=n:e._$Cl=n),n!==void 0&&(t=P(i,n._$AS(i,t.values),n,s)),t}var ot=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:s}=this._$AD,n=(t?.creationScope??E).importNode(e,!0);S.currentNode=n;let o=S.nextNode(),r=0,c=0,a=s[0];for(;a!==void 0;){if(r===a.index){let l;a.type===2?l=new z(o,o.nextSibling,this,t):a.type===1?l=new a.ctor(o,a.name,a.strings,this,t):a.type===6&&(l=new lt(o,this,t)),this._$AV.push(l),a=s[++c]}r!==a?.index&&(o=S.nextNode(),r++)}return S.currentNode=E,n}p(t){let e=0;for(let s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}},z=class i{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,s,n){this.type=2,this._$AH=d,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=n,this._$Cv=n?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=P(this,t,e),D(t)?t===d||t==null||t===""?(this._$AH!==d&&this._$AR(),this._$AH=d):t!==this._$AH&&t!==k&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Gt(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==d&&D(this._$AH)?this._$AA.nextSibling.data=t:this.T(E.createTextNode(t)),this._$AH=t}$(t){let{values:e,_$litType$:s}=t,n=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=I.createElement(Ut(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===n)this._$AH.p(e);else{let o=new ot(n,this),r=o.u(this.options);o.p(e),this.T(r),this._$AH=o}}_$AC(t){let e=Et.get(t.strings);return e===void 0&&Et.set(t.strings,e=new I(t)),e}k(t){ht(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,s,n=0;for(let o of t)n===e.length?e.push(s=new i(this.O(O()),this.O(O()),this,this.options)):s=e[n],s._$AI(o),n++;n<e.length&&(this._$AR(s&&s._$AB.nextSibling,n),e.length=n)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){let s=bt(t).nextSibling;bt(t).remove(),t=s}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},M=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,n,o){this.type=1,this._$AH=d,this._$AN=void 0,this.element=t,this.name=e,this._$AM=n,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=d}_$AI(t,e=this,s,n){let o=this.strings,r=!1;if(o===void 0)t=P(this,t,e,0),r=!D(t)||t!==this._$AH&&t!==k,r&&(this._$AH=t);else{let c=t,a,l;for(t=o[0],a=0;a<o.length-1;a++)l=P(this,c[s+a],e,a),l===k&&(l=this._$AH[a]),r||=!D(l)||l!==this._$AH[a],l===d?t=d:t!==d&&(t+=(l??"")+o[a+1]),this._$AH[a]=l}r&&!n&&this.j(t)}j(t){t===d?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},rt=class extends M{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===d?void 0:t}},at=class extends M{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==d)}},ct=class extends M{constructor(t,e,s,n,o){super(t,e,s,n,o),this.type=5}_$AI(t,e=this){if((t=P(this,t,e,0)??d)===k)return;let s=this._$AH,n=t===d&&s!==d||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,o=t!==d&&(s===d||n);n&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},lt=class{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){P(this,t)}};var Jt=dt.litHtmlPolyfillSupport;Jt?.(I,z),(dt.litHtmlVersions??=[]).push("3.3.3");var Ht=(i,t,e)=>{let s=e?.renderBefore??t,n=s._$litPart$;if(n===void 0){let o=e?.renderBefore??null;s._$litPart$=n=new z(t.insertBefore(O(),o),o,void 0,e??{})}return n._$AI(i),n};var ut=globalThis,y=class extends x{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Ht(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return k}};y._$litElement$=!0,y.finalized=!0,ut.litElementHydrateSupport?.({LitElement:y});var Zt=ut.litElementPolyfillSupport;Zt?.({LitElement:y});(ut.litElementVersions??=[]).push("4.2.2");function Yt(i,t,e){return Math.min(Math.max(i,t),e)}function X(i,t,e){return e<=t?.5:Yt((i-t)/(e-t),0,1)}function Qt(i,t,e){if(i==null)return"unknown";if(i<t)return"below";if(i>e)return"above";let s=e-t;if(s<=0)return"in_band";let n=(i-t)/s;return n<.25?"cool_edge":n>.75?"warm_edge":"in_band"}function Rt(i){let{operative:t,setpoint:e,low:s,high:n}=i;if(s==null||n==null||n<=s)return null;let o=s-1.5,r=n+1.5;return{low:s,high:n,span:n-s,operative:t,setpoint:e,category:i.category??"",verdict:Qt(t,s,n),axisLow:o,axisHigh:r,lowFrac:X(s,o,r),highFrac:X(n,o,r),operativeFrac:t==null?null:X(t,o,r),setpointFrac:e==null?null:X(e,o,r)}}var Tt={in_band:"In comfort band",cool_edge:"Cool edge of band",warm_edge:"Warm edge of band",below:"Below comfort band",above:"Above comfort band",unknown:"No reading",preheating:"Pre-heating",coasting:"Coasting",window:"Window open",failure:"Heating failure",learning:"Learning",shadow:"Shadow active",setpoint:"Setpoint",no_entity:"Select a Poise thermostat entity.",min_left:"min",no_system:"Select the Poise System sensor.",sys_title:"Poise System",demand_on:"Boiler demand",demand_off:"No demand",frost:"Frost override",zones:"zones",heating_n:"heating",flow:"Flow",shed:"shed",shadow_would:"would",update_msg:"New Poise card version available \u2014 reload to update.",reload:"Reload"},te={in_band:"Im Komfortband",cool_edge:"Untere Bandkante",warm_edge:"Obere Bandkante",below:"Unter dem Komfortband",above:"\xDCber dem Komfortband",unknown:"Kein Messwert",preheating:"Vorheizen",coasting:"Auslaufen",window:"Fenster offen",failure:"Heizausfall",learning:"Lernt",shadow:"Shadow aktiv",setpoint:"Sollwert",no_entity:"Bitte eine Poise-Thermostat-Entit\xE4t w\xE4hlen.",min_left:"Min",no_system:"Bitte den Poise-System-Sensor w\xE4hlen.",sys_title:"Poise System",demand_on:"Kesselbedarf",demand_off:"Kein Bedarf",frost:"Frost-Override",zones:"Zonen",heating_n:"heizen",flow:"Vorlauf",shed:"abgeworfen",shadow_would:"w\xFCrde",update_msg:"Neue Poise-Karten-Version verf\xFCgbar \u2014 zum Aktualisieren neu laden.",reload:"Neu laden"};function f(i,t){return((i??"en").toLowerCase().startsWith("de")?te:Tt)[t]??Tt[t]??t}var ee=[{name:"entity",required:!0,selector:{entity:{integration:"poise",domain:"climate"}}},{name:"show_shadow",selector:{boolean:{}}},{name:"compact",selector:{boolean:{}}}],J=class extends y{setConfig(t){this._config=t}shouldUpdate(t){return t.has("hass")||t.has("_config")}_changed(t){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t.detail.value}}))}render(){return!this.hass||!this._config?u``:u`<ha-form
    ...
    ></ha-form>`}};J.properties={hass:{},_config:{state:!0}};customElements.get("poise-card-editor")||customElements.define("poise-card-editor",J);var Z="0.66.0",Nt=!1;function se(){let i=()=>location.reload();"caches"in window?caches.keys().then(t=>Promise.all(t.map(e=>caches.delete(e)))).then(i,i):i()}async function Y(i,t){if(!(Nt||!t?.connection)){Nt=!0;try{let e=await t.connection.sendMessagePromise({type:"poise/card_version"});if(e?.version&&e.version!==Z){let s=t.locale?.language;i.dispatchEvent(new CustomEvent("hass-notification",{detail:{message:`${f(s,"update_msg")} (${Z} \u2192 ${e.version})`,duration:-1,dismissable:!0,action:{text:f(s,"reload"),action:se}},bubbles:!0,composed:!0}))}}catch{}}}function L(i){let t=typeof i=="string"?parseFloat(i):i;return typeof t=="number"&&!Number.isNaN(t)?t:null}var V=class extends y{static getConfigElement(){return document.createElement("poise-system-card-editor")}static getStubConfig(t){return{type:"custom:poise-system-card",entity:Object.keys(t.states).find(s=>s.startsWith("binary_sensor.")&&t.states[s].attributes.zone_count!==void 0)??""}}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config=t}getCardSize(){return 2}getGridOptions(){return{columns:12,rows:"auto",min_columns:4,min_rows:4}}updated(){this.hass&&Y(this,this.hass)}shouldUpdate(t){if(t.has("_config"))return!0;let e=t.get("hass");return!e||!this._config?.entity?!0:e.states[this._config.entity]!==this.hass.states[this._config.entity]}_moreInfo(){this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:this._config.entity},bubbles:!0,composed:!0}))}render(){let t=this.hass?.locale?.language,e=this._config?.entity,s=e?this.hass.states[e]:void 0;if(!s)return u`<ha-card
      ...
      <div class="wrap" @click=${this._moreInfo}>
        <div class="state ${o?"on":""}">
          ...
          ${n.frost_override?u`<em class="frost">${f(t,"frost")}</em>`:d}
        </div>
        <div class="stats">
          <div>
    ...
    </ha-card>`}};V.properties={hass:{},_config:{state:!0}},V.styles=R`
  ...
  `;var Q=class extends y{setConfig(t){this._config=t}shouldUpdate(t){return t.has("hass")||t.has("_config")}_changed(t){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t.detail.value}}))}render(){return!this.hass||!this._config?u``:u`<ha-form
      ...
      .computeLabel=${t=>t.name}
      @value-changed=${this._changed}
    ></ha-form>`}};Q.properties={hass:{},_config:{state:!0}};customElements.get("poise-system-card-editor")||customElements.define("poise-system-card-editor",Q);customElements.get("poise-system-card")||customElements.define("poise-system-card",V);window.customCards=window.customCards||[];window.customCards.push({type:"poise-system-card",name:"Poise System",preview:!0,description:"Multi-zone boiler demand, flow & load shedding for the Poise hub."});function Ot(i,t,e){return Math.min(Math.max(i,t),e)}function Dt(i,t,e,s=300,n=90,o=1){let r=[];for(let g of i)g.op!=null&&r.push(g.op),g.sp!=null&&r.push(g.sp);if(t!=null&&r.push(t),e!=null&&r.push(e),r.length===0||i.length===0)return null;let c=Math.min(...r)-o,a=Math.max(...r)+o,l=i[0].t,h=i[i.length-1].t-l||1,_=a-c||1,$=g=>(g-l)/h*s,b=g=>n-(g-c)/_*n,U=g=>i.filter(A=>g(A)!=null).map(A=>`${$(A.t).toFixed(1)},${b(g(A)).toFixed(1)}`).join(" ");return{width:s,height:n,opPath:U(g=>g.op),spPath:U(g=>g.sp),bandTop:e==null?0:Ot(b(e),0,n),bandBottom:t==null?n:Ot(b(t),0,n),vMin:c,vMax:a}}var v={min:16,max:28,start:135,sweep:270};function ne(i,t,e){return Math.min(Math.max(i,t),e)}function B(i,t=v){let e=ne((i-t.min)/(t.max-t.min),0,1);return t.start+e*t.sweep}function ie(i,t=v){let e=i;for(;e<t.start;)e+=360;for(;e>=t.start+360;)e-=360;if(e<=t.start+t.sweep)return e;let s=e-(t.start+t.sweep);return t.start+360-e<s?t.start:t.start+t.sweep}function oe(i,t=v){let s=(ie(i,t)-t.start)/t.sweep;return t.min+s*(t.max-t.min)}function F(i,t,e,s){let n=s*Math.PI/180;return{x:i+e*Math.cos(n),y:t+e*Math.sin(n)}}function mt(i,t,e,s,n){if(n<=s)return"";let o=F(i,t,e,s),r=F(i,t,e,n),c=n-s>180?1:0;return`M ${o.x.toFixed(2)} ${o.y.toFixed(2)} A ${e} ${e} 0 ${c} 1 ${r.x.toFixed(2)} ${r.y.toFixed(2)}`}function It(i,t,e=v){let s=Math.atan2(t,i)*180/Math.PI;return s<0&&(s+=360),oe(s,e)}function p(i){let t=typeof i=="string"?parseFloat(i):i;return typeof t=="number"&&!Number.isNaN(t)?t:null}var j=class extends y{constructor(){super(...arguments);this._history=[];this._histFor=null;this._dragging=!1;this._pending=null;this._dialCfg=v}static getConfigElement(){return document.createElement("poise-card-editor")}static getStubConfig(e){return{type:"custom:poise-card",entity:Object.keys(e.states).find(n=>n.startsWith("climate.")&&e.states[n].attributes.comfort_low!==void 0)??"",show_shadow:!0}}setConfig(e){if(!e)throw new Error("Invalid configuration");if(e.entity&&!e.entity.startsWith("climate."))throw new Error("Poise card: entity must be a climate entity");this._config={show_shadow:!0,...e}}getCardSize(){return 4}getGridOptions(){return this._config?.compact?{columns:6,rows:"auto",min_columns:4,min_rows:6}:{columns:12,rows:"auto",min_columns:6,min_rows:9}}shouldUpdate(e){if(this._dragging||e.has("_config"))return!0;let s=e.get("hass");return!s||!this._config?.entity?!0:s.states[this._config.entity]!==this.hass.states[this._config.entity]}_setpoint(e){let s=this._config.entity;if(!s)return;let n=this.hass.states[s];if(!n)return;let o=p(n.attributes.target_temperature_step)??.5,r=p(n.attributes.heat_sp)??p(n.attributes.temperature)??21;this.hass.callService("climate","set_temperature",{entity_id:s,temperature:Math.round((r+e*o)*10)/10})}updated(){this.hass&&Y(this,this.hass);let e=this._config?.entity;e&&this.hass&&this._histFor!==e&&(this._histFor=e,this._loadHistory(e))}async _loadHistory(e){if(!this.hass.connection)return;let s=new Date,n=new Date(s.getTime()-24*3600*1e3);try{let r=(await this.hass.connection.sendMessagePromise({type:"history/history_during_period",start_time:n.toISOString(),end_time:s.toISOString(),entity_ids:[e],minimal_response:!1,no_attributes:!1}))?.[e]??[],c={},a=[];for(let l of r){l.a&&(c={...c,...l.a});let m=(p(l.lu)??p(l.lc)??0)*1e3;a.push({t:m,op:p(c.operative_temperature)??p(c.current_temperature),sp:p(c.heat_sp)??p(c.temperature)})}this._history=a,this.requestUpdate()}catch{}}_moreInfo(){this._config.entity&&this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:this._config.entity},bubbles:!0,composed:!0}))}_chart(e,s){let n=Dt(this._history,e,s,300,80);return n?u`<svg
      class="chart"
    ...
    >
      ...
      >`;let o=n.attributes,r=p(o.operative_temperature)??p(o.current_temperature),c=p(o.heat_sp)??p(o.temperature),a=Rt({operative:r,setpoint:c,low:p(o.comfort_low),high:p(o.comfort_high),category:o.category??null});return u`<ha-card .header=${o.friendly_name??"Poise"}>
      <div class="wrap ${this._config.compact?"compact":""}">
        ...
        ${this._config.compact?d:u`${this._control(this._pending??c,e)}
              ${this._chart(p(o.comfort_low),p(o.comfort_high))}
              ${this._chips(o,e)}`}
        ${this._learn(o,e)}
      </div>
    </ha-card>`}_dial(e,s){let n=p(e.operative_temperature)??p(e.current_temperature),o=p(e.heat_sp)??p(e.temperature),r={min:p(e.min_temp)??v.min,max:p(e.max_temp)??v.max,start:v.start,sweep:v.sweep};this._dialCfg=r.max>r.min?r:v;let c=this._pending??o??n??this._dialCfg.min,a=p(e.comfort_low),l=p(e.comfort_high),m=100,h=100,_=80,$=mt(m,h,_,v.start,v.start+v.sweep),b=a!=null&&l!=null?mt(m,h,_,B(Math.min(a,l),this._dialCfg),B(Math.max(a,l),this._dialCfg)):"",U=String(e.hvac_action??""),g=U==="heating"?"heat":U==="cooling"?"cool":"",A=F(m,h,_,B(c,this._dialCfg)),tt=n!=null?F(m,h,_,B(n,this._dialCfg)):null;return u`<div class="dialwrap">
      <svg
        class="dial"
        viewBox="0 0 200 200"
    ...
    </div>`}_chips(e,s){let n=[];e.preheating&&n.push(this._chip("mdi:fire-circle",f(s,"preheating"),e.minutes_to_comfort,s)),e.coasting&&n.push(this._chip("mdi:coffee",f(s,"coasting"),e.minutes_to_setback,s)),e.window_open&&n.push(this._chip("mdi:window-open",f(s,"window"))),e.heating_failure&&n.push(this._chip("mdi:alert",f(s,"failure")));let o=e.binding_lower_cause;return o&&o!=="en16798"&&n.push(this._chip("mdi:shield-alert",String(o))),n.length?u`<div class="chips" @click=${this._moreInfo}>${n}</div>`:d}_chip(e,s,n,o){let r=p(n);return u`<div class="chip">
      <ha-icon icon=${e}></ha-icon><span>${s}</span>
      ${r!=null?u`<em>${Math.round(r)} ${f(o,"min_left")}</em>`:d}
    </div>`}_learn(e,s){let n=p(e.confidence),o=this._config.show_shadow&&(e.mpc_active||e.tpi_active||e.pi_active),r=p(e.pi_setpoint),c=p(e.mpc_setpoint),a=e.tpi_active?`TPI ${Math.round(p(e.tpi_valve_percent)??0)}%`:e.pi_active&&r!=null?`PI ${r.toFixed(1)}\xB0`:e.mpc_active&&c!=null?`MPC ${c.toFixed(1)}\xB0`:"";return u`<div class="learn">
      ${n!=null?u`<div class="bar">
            <i style="width:${(n*100).toFixed(0)}%"></i>
          </div>
          <span>${f(s,"learning")} ${(n*100).toFixed(0)}%</span>`:d}
      ${o?u`<div class="pill">
            ${f(s,"shadow")}${a?u` · ${a}`:d}
          </div>`:d}
    </div>`}};j.properties={hass:{},_config:{state:!0}},j.styles=R`
